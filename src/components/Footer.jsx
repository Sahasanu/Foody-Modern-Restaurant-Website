...
function Footer() {
    return (
        <div className='footercontainer w-[100%] text-[#888383] mt-[10vh] pb-[10vh]'>
            <div className='w-[65%]  flex   ml-auto mr-auto'>
                <div className="contact w-[30%] text-center flex-col flex gap-[10px] mt-[15px]">
                    <p className='text-[20px] font-[500]  text-[#dfd7ba]'>Contact Us</p>
                ...
                <div className="logo w-[40%]  flex flex-col items-center">
                    ...
                    <div>
                        <p className='w-[80%] ml-auto mr-auto  text-center'>"The best way to find yourself is to lose yourself in the
                            service of others."</p>
                    </div>
                ...
                <div className="workingHours text-center  w-[30%] mt-[15px] flex-col flex gap-[7px]">
                    <p className='text-[20px] font-[500] text-[#dfd7ba]'>Working Hours</p>
            ...
            <div className="copy w-[100%] text-center mt-[3vh]">
